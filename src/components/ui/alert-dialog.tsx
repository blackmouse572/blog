...
>(({ className, ...props }, forwardedRef) => {
  ...
  return <AlertDialogPrimitive.Overlay {...props} ref={forwardedRef} className={overlay({ className })} />;
});
...
>(({ className, mixed, fancy, ...props }, forwardedRef) => {
  ...
  return (
    <AlertDialogPrimitive.Content {...props} ref={forwardedRef} className={content({ fancy, mixed, className })} />
  );
});
...
const AlertDialogActions = React.forwardRef<React.ElementRef<'div'>, React.ComponentPropsWithoutRef<'div'>>(
  ({ className, ...props }, forwardedRef) => {
