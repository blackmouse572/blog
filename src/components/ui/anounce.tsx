...
export const AnnonceRoot: React.FC<AnnonceRootVariantsProps> = ({
  ...
  return (
    <Component href={href} className={annonceRoot({ variant, size, className })} {...props}>
      {children}
    </Component>
  );
};
...
export const AnnonceMessage: React.FC<AnnonceMessageProps> = ({ className, children, ...props }) => (
